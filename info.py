...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "📂 <em>File Name</em>: <code>{file_name}</code>\n\n ♻ <em>File Size</em>:{file_size}\n\n<b><i>🎞Latest Movies -</i> [ELDORADO](https://t.me/+53lB8qzQaGFlNDll)\n\n<u><i>📌 Download This File And Play on VLC or MX Player For Better Experience And Without Sound Issues.</i></u></b>")
